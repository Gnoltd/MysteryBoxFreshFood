  ...
  return (
    <Card className="bg-slate-900 border-slate-800">
      <CardHeader>
        ...
        <CardDescription className="text-slate-400">{t('auth.welcomeBack')}</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <p className="text-slate-400 text-sm text-center mt-4">
          {t('auth.noAccount')} <Link to="/register" className="text-indigo-400 hover:underline">{t('auth.register')}</Link>
        </p>
      </CardContent>
    </Card>
  )
