        ...
        <>
          ...
          <main className="flex-1 flex flex-col items-center justify-center gap-8 px-6 pt-20 pb-28 md:pb-8">
            ...
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 flex-shrink-0">
              ...
              {/* Corner brackets */}
              <div className="absolute -top-[2px] -left-[2px] w-14 h-14 border-t-[4px] border-l-[4px] border-[#c0c1ff] rounded-tl-[1.25rem] z-30 pointer-events-none"
                style={{ filter: 'drop-shadow(0 0 8px rgba(192,193,255,0.4))' }} />
              <div className="absolute -top-[2px] -right-[2px] w-14 h-14 border-t-[4px] border-r-[4px] border-[#ddb7ff] rounded-tr-[1.25rem] z-30 pointer-events-none"
                style={{ filter: 'drop-shadow(0 0 8px rgba(221,183,255,0.4))' }} />
              <div className="absolute -bottom-[2px] -left-[2px] w-14 h-14 border-b-[4px] border-l-[4px] border-[#ddb7ff] rounded-bl-[1.25rem] z-30 pointer-events-none"
                style={{ filter: 'drop-shadow(0 0 8px rgba(221,183,255,0.4))' }} />
              <div className="absolute -bottom-[2px] -right-[2px] w-14 h-14 border-b-[4px] border-r-[4px] border-[#c0c1ff] rounded-br-[1.25rem] z-30 pointer-events-none"
                style={{ filter: 'drop-shadow(0 0 8px rgba(192,193,255,0.4))' }} />
              {/* Center reticle */}
